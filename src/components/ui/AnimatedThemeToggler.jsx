...
export const AnimatedThemeToggler = ({
  ...
  const isLight = isControlled ? theme === "light" : internalIsLight
  ...
  useEffect(() => {
    ...
    const updateTheme = () => {
      setInternalIsLight(document.documentElement.classList.contains("light"))
    }
  ...
  }, [shape, fromCenter, duration, isLight, isControlled, onThemeChange])
